...
// usage: logback('inside coolFunc',this,arguments);
 ...
 *       console.logback('Button Clicked!');
 *     });
 *
...
//   vjs.logback('unloadingTech')
//   this.unloadTech();
//   vjs.logback('unloadedTech')
//   if (betweenFn) { betweenFn.call(); }
//   vjs.logback('LoadingTech')
//   this.loadTech(this.techName, { src: this.cache_.src })
//   vjs.logback('loadedTech')
// },
...
vjs.Player.prototype.trackProgress = function(){
  ...
  this.progressInterval = setInterval(vjs.bind(this, function(){
    ...
    // logback(this.cache_.bufferEnd, this.buffered().end(0), this.duration())
...
vjs.ChaptersTrackMenuItem.prototype.update = function(){
  ...
  // vjs.logback(currentTime, cue.startTime);
