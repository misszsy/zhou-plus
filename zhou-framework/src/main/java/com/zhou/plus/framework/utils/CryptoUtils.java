...
public class CryptoUtils {
    ...
    public static String createToken(Integer num) {
        String base = "XeNGByco8bnIhQyNO36wApB7iYiZ7YszRSuosSeLNQL";
    ...
    public static String encryptPassword(String plainPassword) {
        String md5Salt = new Md5Hash(plainPassword).toString();
        String encryptPassword = new Sha256Hash(plainPassword, md5Salt).toString();
    ...
    public static boolean validatePassword(String plainPassword, String encryptPassword) {
        String tempEncryptPassword = encryptPassword(plainPassword);
        return tempEncryptPassword.equals(encryptPassword);
    }
